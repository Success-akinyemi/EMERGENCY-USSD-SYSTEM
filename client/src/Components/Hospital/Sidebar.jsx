...
function Sidebar() {
  ...
  return (
    <div className='fixed top-0 left-0 w-[20%] h-[100vh] bg-light-blue bg py-[24px] px-[18px] z-[999]'>
        <div className="flex flex-col items-center justify-center w-full">
            ...
            <div className="max-phone:mt-3 mt-6 flex flex-col items-start h-[70vh] overflow-y-auto scrollbar w-full gap-1">
                {
                    menu.map((item, idx) => (
